                        ...
                        <div className="md:col-span-2 bg-white p-8 md:p-10 rounded-2xl shadow-lg border border-gray-100">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="message" onChange={handleChange} rows="4" className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder-gray-500 focus:border-brand-gold focus:ring-1 focus:ring-brand-gold outline-none transition-all" placeholder="How can we help you?"></textarea>
                                </div>
                                ...
                                {submitStatus === 'success' ? (
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <button
                                            ...
                                            className="w-full py-4 bg-gray-900 text-white font-bold rounded-xl hover:bg-brand-gold transition-all duration-300 shadow-xl hover:shadow-brand-gold/30 flex items-center justify-center disabled:opacity-70"
                                        >
                                            {isSubmitting ? (
